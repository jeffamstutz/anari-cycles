...
// FrameDisplayDriver definitions /////////////////////////////////////////////

struct FrameDisplayDriver::Impl
{
...
FrameDisplayDriver::FrameDisplayDriver()
{
  m_impl = std::make_shared<Impl>();
}

void FrameDisplayDriver::write_render_tile(const Tile &tile)
{
...
bool FrameDisplayDriver::renderBegin(Frame *f)
{
...
void FrameDisplayDriver::renderEnd()
{
  std::lock_guard<std::mutex> lock(m_impl->mutex);
...
bool FrameDisplayDriver::ready() const
{
  return m_impl->renderFinished;
}

void FrameDisplayDriver::extractColorPass(const Tile &tile)
{
...
void FrameDisplayDriver::extractDepthPass(const Tile &tile)
{
